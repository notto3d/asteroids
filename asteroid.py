...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        asteroid2_vector = self.velocity.rotate(random_angle * -1)
        split_asteroid_radius = self.radius - ASTEROID_MIN_RADIUS
        asteroid1 = Asteroid(self.position.x, self.position.y, split_asteroid_radius)
        asteroid2 = Asteroid(self.position.x, self.position.y, split_asteroid_radius)
